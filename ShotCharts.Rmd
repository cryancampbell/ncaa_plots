...
#bestScorers
bestScorer <- data.frame(matrix(0, ncol = 11, nrow = 14), row.names = quadrants[c(2,8,5,12,3,13,9,1,4,11,6,7,10,14)])
colnames(bestScorer) <- c("shooter","shots","points","games","pointsPerGame","quadFGPer",
                          "shooterEfficiency","teamName","logo","xPlot","yPlot")
...
for (q in c(2,8,5,12,3,13,9,1,4,11,6,7,10,14)) {
  ...
  #within here is probably the best place to continue populating this DF
  #query shatsTrans for teamName number of shots, quadFGPer 
