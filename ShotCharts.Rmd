...
#lastGame("nc-state-wolfpack")
lastGame("virginia-cavaliers")
lastGame("kansas-jayhawks")

chartShots(teamPlot = "north-carolina-tar-heels", plotType = "kg", games = "all")
ggsave("plots/unc_season_4games.png")
chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "NassirLittle", plotType = "kg", games = "all")
ggsave("plots/nas_kg_5games.png")
chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "NassirLittle", plotType = "shot", games = "all")
ggsave("plots/nas_shot_5games.png")

chartShots(teamPlot = "duke-blue-devils", plotType = "kg", games = "all")
ggsave("plots/duke_kg_mauifinal.png")

chartShots(teamPlot = "gonzaga-bulldogs", plotType = "kg", games = "all")
ggsave("plots/zags_kg_mauifinal.png")


chartShots(teamPlot = "north-carolina-tar-heels", plotType = "kg", games = "all")
ggsave("plots/unc_LVI.png")
chartShots(teamPlot = "texas-longhorns", plotType = "kg", games = "all")
ggsave("plots/tex_LVI.png")
chartShots(teamPlot = "michigan-state-spartans", plotType = "kg", games = "all")
ggsave("plots/msu_LVI.png")
chartShots(teamPlot = "ucla-bruins", plotType = "kg", games = "all")
ggsave("plots/ucla_LVI.png")
...
chartShots(teamPlot = "duke-blue-devils", chartPlayer = "CamReddish", plotType = "kg", games = "all")
ggsave("plots/red_kg_4games.png")
chartShots(teamPlot = "duke-blue-devils", chartPlayer = "ZionWilliamson", plotType = "kg", games = "all")
ggsave("plots/zion_kg_4games.png")
chartShots(teamPlot = "duke-blue-devils", chartPlayer = "RJBarrett", plotType = "kg", games = "all")
ggsave("plots/rj_kg_4games.png")
chartShots(teamPlot = "duke-blue-devils", chartPlayer = "TreJones", plotType = "kg", games = "all")
ggsave("plots/tre_kg_4games.png")



chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "KennyWilliams", plotType = "shot", games = "some", n = 1)

chartShots(teamPlot = "kansas-jayhawks", chartPlayer = "UdokaAzubuike", plotType = "kg", games = "all")
ggsave("plots/azubuike_kg_2games.png")
chartShots(teamPlot = "kansas-jayhawks", chartPlayer = "UdokaAzubuike", plotType = "shot", games = "all")
ggsave("plots/azubuike_shot_2games.png")

chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "GarrisonBrooks", plotType = "kg", games = "all")
chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "GarrisonBrooks", plotType = "shot", games = "all")


ggplot(subset(shotsTrans, shooter == "UdokaAzubuike" | shooter == "GarrisonBrooks")) +
  geom_point(aes(x = dist, y = points, col = shooter))
...
ggplot(subset(shotsTrans, shooter == "UdokaAzubuike"), aes(x = dist, y = points/2, col = shooter)) +
  geom_point() +
  geom_smooth(method = "glm", 
    method.args = list(family = "binomial"), 
    se = FALSE) 
ggsave("plots/azubuike_byDist.png")

ggplot(subset(shotsTrans, shooter == "UdokaAzubuike")[-6,], aes(x = dist, y = points/2, col = shooter)) +
  geom_point() +
  geom_smooth(method = "glm", 
    method.args = list(family = "binomial"), 
    se = FALSE) 
...
ggsave("plots/luke_kg_5games.png")

chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "CobyWhite", plotType = "shot", games = "some", n = 1)
ggsave("plots/coby_shot_texas.png")
chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "CobyWhite", plotType = "kg", games = "all")
ggsave("plots/coby_kg_6games.png")


chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "SeventhWoods", plotType = "kg", games = "all")
ggsave("plots/sev_kg_4games.png")
chartShots(teamPlot = "north-carolina-tar-heels", chartPlayer = "SeventhWoods", plotType = "shot", games = "all")
...
reducedShots$halfText <- ifelse(reducedShots$half == 1, "first", "second")

ggplot(reducedShots, aes( x = baseline, y = depth)) + 
  #geom_point(aes(x=25, y=5.25), col = "gray", size = 8) + 
  ylim(0,40)  + xlim(0,50) + 
  geom_jitter(aes(col = halfText, shape = outcome), size = 5, width = 1.5, height = 1.5, alpha = .8) +
  ...
  theme(axis.text.x = element_blank(),
        axis.text.y = element_blank(), axis.ticks.x = element_blank(),
        axis.ticks.y = element_blank(), axis.title = element_blank()
  ) + scale_shape_manual(values=c(16, 88)) + ggtitle("Gonzaga v. Duke, Zags Shots by Half")

ggsave("plots/Gonzaga_Bolden_effect.png")
